...
public class StatefulGenericHibernateDao<T, Id extends Serializable> implements HibernateDao<T, Id>, Serializable {

    private Class<T> persistentClass;
    @Inject @ConventionsEntityManager(type= Type.EXTENDED) 
    ...
    public WrappedData<T> findPaginated(final int first, final int pageSize, String sortField, SortOrder sortOrder, final DetachedCriteria dc) {
        ...
        int size = getRowCount(dc) == null ? 0:getRowCount(dc).intValue();   
